...
**טרם קיים קוד עבורו (לפי ה-PRD המעודכן):**
- `apps/worker` — תזכורות אמיתיות (התיקייה עדיין placeholder בלבד; שליחת SMS בפועל היא Phase 4 לפי הערות בקוד).
- הודעות כלליות (`Announcement`, US-009).
